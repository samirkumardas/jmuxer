(function (global, factory) {
  ...
  */
  ...
  var H264Remuxer = /*#__PURE__*/function (_BaseRemuxer) {
    ...
    function H264Remuxer(timescale, duration) {
      var _this;
    ...
    _createClass(RemuxController, [{
      ...
      value: function addTrack(type) {
        ...
        if (type === 'audio' || type === 'both') {
          var aacRemuxer = new AACRemuxer(this.timescale, this.mediaDuration);
  ...
  var JMuxer = /*#__PURE__*/function (_Event) {
    ...
    function JMuxer(options) {
      ...
      _this.remuxController = new RemuxController(_this.env, options.live);
