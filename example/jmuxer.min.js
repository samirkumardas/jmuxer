(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('stream'), require('fs')) :
  typeof define === 'function' && define.amd ? define(['stream', 'fs'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.JMuxer = factory(global.stream, global.fs));
}(this, (function (stream, fs) { 'use strict';
  ...
  */
  ...
  var Mp4Controller = /*#__PURE__*/function (_Event) {
    _inherits(Mp4Controller, _Event);

    var _super = _createSuper(Mp4Controller);

    function Mp4Controller(file) {
      var _this;

      _classCallCheck(this, Mp4Controller);

      _this = _super.call(this, 'buffer');
      _this.stream = new stream.Readable({
        read: function read(size) {}
      });
      _this["export"] = fs.createWriteStream(file);

      _this["export"].on('error', function (error) {
        throw 'Unable to create export file - ' + error;
      });

      _this.stream.pipe(_this["export"]);

      return _this;
    }

    _createClass(Mp4Controller, [{
      key: "getStream",
