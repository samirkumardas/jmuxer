  ...
  var H265Remuxer = /*#__PURE__*/function (_BaseRemuxer) {
    ...
    _createClass(H265Remuxer, [{
      ...
      value: function parseSPS(sps) {
        ...
        this.mp4track.sps = [new Uint8Array(sps)];
        console.log(config);
        this.mp4track.codec = "hvc1.".concat(config.profile_idc, ".").concat(config.profile_compatibility_flags.toString(16)) + ".L".concat(config.level_idc).concat(config.tier_flag ? 'H' : 'L');
