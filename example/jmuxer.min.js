(function (global, factory) {
  ...
  */
  ...
  var RemuxController = /*#__PURE__*/function (_Event) {
    ...
    function RemuxController(env, live, frameDuration) {
      var _this;
  ...
  var JMuxer = /*#__PURE__*/function (_Event) {
    ...
    function JMuxer(options) {
      ...
      var defaults = {
        ...
        onKeyframePosition: function onKeyframePosition() {} // function called when a keyframe is detected thus the provided time is seekable
      };
      ...
      _this.remuxController = new RemuxController(_this.env, options.live, _this.frameDuration);
      ...
      if (typeof _this.options.onKeyframePosition === 'function') {
        _this.remuxController.on('keyframePosition', function (time) {
          _this.dispatch('keyframePosition', time);
        });
      }
      return _this;
    }
