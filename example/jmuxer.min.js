        ...
        value: function remux(frames) {
            ...
            try {
                for (var _iterator = frames[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                    ...
                    try {
                        for (var _iterator2 = frame.units[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
                ...
                try {
                    for (var _iterator3 = this.trackTypes[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
                        ...
                        if (pay && pay.byteLength) {
                            ...
                            log('put segment (' + _type + '): ' + _track.seq + ' dts: ' + _track.dts + ' gop: ' + _track.mp4track.samples.length + ' second: ' + duration);
                            _track.flush();
                        }
                    }
                } catch (err) {
...
var JMuxmer = function (_Event) {
    ...
    createClass(JMuxmer, [{
        ...
        value: function getVideoFrames(nalus, duration) {
            ...
            log('jmuxer: No. of frames of the last chunk: ' + frames.length);
            return frames;
        }
    }, {
        key: 'getAudioFrames',
