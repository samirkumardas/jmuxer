  ...
  var MP4 = /*#__PURE__*/function () {
    ...
    _createClass(MP4, null, [{
      ...
      value: function hev1(track) {
        ...
        profile_space << 6 | tier_flag << 5 | profile_idc, profile_compatibility_flags >> 24 & 0xFF, profile_compatibility_flags >> 16 & 0xFF, profile_compatibility_flags >> 8 & 0xFF, profile_compatibility_flags & 0xFF, Number(constraint_indicator_flags >> 40n & 0xFFn), Number(constraint_indicator_flags >> 32n & 0xFFn), Number(constraint_indicator_flags >> 24n & 0xFFn), Number(constraint_indicator_flags >> 16n & 0xFFn), Number(constraint_indicator_flags >> 8n & 0xFFn), Number(constraint_indicator_flags & 0xFFn), level_idc, 0xF0, 0x00,
        ...
        0x00, 0x00,
        // avgFrameRate = 0 (unless you want to use track.fps*1000)
        0x00,
        // constantFrameRate, numTemporalLayers, etc.
        0x03,
        // numOfArrays

        0x20,
        // array_completeness + NAL_unit_type (32 = VPS)
        0x00, 0x01].concat(_toConsumableArray(vps), [0x21,
  ...
  */
  ...
  var NALU264 = /*#__PURE__*/function () {
    ...
    _createClass(NALU264, [{
      ...
      value: function toString() {
        return "".concat(NALU264.TYPES[this] || 'UNKNOWN', ": NRI: ").concat(this.getNri());
      }
    }, {
      key: "getNri",
  ...
  var H265Parser = /*#__PURE__*/function () {
    ...
    _createClass(H265Parser, null, [{
      ...
      value: function readSPS(data) {
        ...
        var constraint_indicator_flags_high = decoder.readUInt(); // 32 bits
        var constraint_indicator_flags_low = decoder.readUShort(); // 16 bits
        var constraint_indicator_flags = BigInt(constraint_indicator_flags_high) << 16n | BigInt(constraint_indicator_flags_low);
  ...
  var NALU265 = /*#__PURE__*/function () {
    ...
    _createClass(NALU265, [{
      key: "toString",
      value: function toString() {
        return "".concat(NALU265.TYPES[this] || 'UNKNOWN', ": Layer: ").concat(this.nuhLayerId, ", Temporal Id: ").concat(this.nuhTemporalIdPlus1);
      }
    }, {
      key: "type",
      value: function type() {
      ...
      get: function get() {
        var _ref;
        return _ref = {}, _defineProperty(_ref, NALU265.IDR_W_RADL, 'IDR'), _defineProperty(_ref, NALU265.IDR_N_LP, 'IDR2'), _defineProperty(_ref, NALU265.CRA, 'CRA'), _defineProperty(_ref, NALU265.VPS, 'VPS'), _defineProperty(_ref, NALU265.SPS, 'SPS'), _defineProperty(_ref, NALU265.PPS, 'PPS'), _defineProperty(_ref, NALU265.AUD, 'AUD'), _defineProperty(_ref, NALU265.SEI, 'SEI'), _defineProperty(_ref, NALU265.SEI2, 'SEI2'), _ref;
      }
    }]);
    return NALU265;
  }();
  ...
  var H265Remuxer = /*#__PURE__*/function (_BaseRemuxer) {
    ...
    _createClass(H265Remuxer, [{
      ...
      value: function parseSPS(sps) {
        ...
        this.mp4track.sps = [new Uint8Array(sps)];
        console.log(config);
        this.mp4track.codec = "hvc1.".concat(config.profile_idc, ".").concat(config.profile_compatibility_flags.toString(16)) + ".L".concat(config.level_idc).concat(config.tier_flag ? 'H' : 'L') + ".".concat(config.constraint_indicator_flags.toString(16));
        this.mp4track.hvcC = {
